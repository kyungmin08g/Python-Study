...
# 그러기 때문에 한 번만 사용할 간단한 함수를 다른 함수에 전달할 때 사용하는 것이 가장 좋습니다.
# 
# { 형식 }
# lambda parameter: return value

add_second = lambda a, b: a + b
# 위 람다 함수는 일반적인 함수로 풀어보면 다음과 같이 표현할 수 있습니다.
def add(a, b):
  return a + b

print(add_second(2, 3)) # (terminal print: 5)

# 람다 함수는 이름이 없어 다음과 같이 바로 호출하여 실행할 수 있습니다.
print((lambda x, y: x * y)(7, 6)) # (terminal print: 42)

# 조건문과 함께 사용 가능합니다.
check = lambda num: "짝수" if num % 2 == 0 else "홀수"
print(check(9)) # (terminal print: 홀수)
